...
struct FWanaSelectedCharacterEnhancementSnapshot
{
    ...
    bool bHasRuntimeAnimationAdapterComponent = false;
    ...
    bool bRuntimeAnimationAdapterHookReadable = false;
    bool bRuntimeAnimationAdapterReportReadable = false;
    bool bRuntimeAnimationAdapterSharedAnimBPDetected = false;
    bool bRuntimeAnimationAdapterDirectGraphEditSafe = false;
    ...
    FString RuntimeAnimationAdapterReadiness;
    FString RuntimeAnimationAdapterRecommendedStrategy;
    FString RuntimeAnimationAdapterDirectGraphSafety;
    FString RuntimeAnimationAdapterSharedAnimBPRisk;
    FString RuntimeAnimationAdapterReportPath;
    FString RuntimeAnimationAdapterDetail;
    FString RuntimeAnimationAdapterBehaviorIntent;
    FString RuntimeAnimationAdapterVisibleBehaviorLabel;
    FString RuntimeAnimationAdapterPostureHint;
    FString RuntimeAnimationAdapterPostureCategory;
    FString RuntimeAnimationAdapterFallbackHint;
    EWAYReactionState RuntimeAnimationAdapterReactionState = EWAYReactionState::Observational;
    EWAYRelationshipState RuntimeAnimationAdapterRelationshipState = EWAYRelationshipState::Neutral;
    EWAYBehaviorPreset RuntimeAnimationAdapterRecommendedBehavior = EWAYBehaviorPreset::None;
    EWAYBehaviorExecutionMode RuntimeAnimationAdapterExecutionMode = EWAYBehaviorExecutionMode::Unknown;
    EWanaPhysicalState RuntimeAnimationAdapterPhysicalState = EWanaPhysicalState::Stable;
    float RuntimeAnimationAdapterStabilityScore = 1.0f;
    float RuntimeAnimationAdapterInstabilityAlpha = 0.0f;
    float RuntimeAnimationAdapterRecoveryProgress = 1.0f;
    FVector RuntimeAnimationAdapterImpactDirection = FVector::ZeroVector;
    float RuntimeAnimationAdapterImpactStrength = 0.0f;
    bool bRuntimeAnimationAdapterBracing = false;
    bool bRuntimeAnimationAdapterNeedsRecovery = false;
    bool bRuntimeAnimationAdapterCanCommitToMovement = true;
    bool bRuntimeAnimationAdapterCanCommitToAttack = true;
